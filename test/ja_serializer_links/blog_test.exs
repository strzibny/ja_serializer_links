defmodule JaSerializerLinks.BlogTest do
  use JaSerializerLinks.DataCase

  alias JaSerializerLinks.Blog
  ...
  describe "comments" do
    ...
    @valid_attrs %{body: "some body", post_id: 42}
    @update_attrs %{body: "some updated body", post_id: 43}
    @invalid_attrs %{body: nil, post_id: nil}
